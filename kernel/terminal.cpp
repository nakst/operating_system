		...
		for (int i = 0; i < 8; i++) {
			...
			switch (graphics.colorMode) {
				case VIDEO_COLOR_24_RGB: {
					...
					graphics.linearBuffer[y * graphics.strideY + x * 3 + 0] = c;
					graphics.linearBuffer[y * graphics.strideY + x * 3 + 1] = c;
					graphics.linearBuffer[y * graphics.strideY + x * 3 + 2] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 3 + 0] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 3 + 1] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 3 + 2] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 3 + 0] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 3 + 1] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 3 + 2] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 3 + 0] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 3 + 1] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 3 + 2] = c;
				} break;
				...
				case VIDEO_COLOR_32_XRGB: {
					...
					uintptr_t x = column * 18 + i * 2;
					uint8_t c = bit ? 0xEE : 0x44;
					graphics.linearBuffer[y * graphics.strideY + x * 4 + 0] = c;
					graphics.linearBuffer[y * graphics.strideY + x * 4 + 1] = c;
					graphics.linearBuffer[y * graphics.strideY + x * 4 + 2] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 4 + 0] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 4 + 1] = c;
					graphics.linearBuffer[y * graphics.strideY + (x + 1) * 4 + 2] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 4 + 0] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 4 + 1] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + x * 4 + 2] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 4 + 0] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 4 + 1] = c;
					graphics.linearBuffer[(y + 1) * graphics.strideY + (x + 1) * 4 + 2] = c;
				} break;
